...
public class XlsWriter {
    ...
    public static void writeXlsStatistics(List<Statistics> statisticsList,
        ...
        logger.log(Level.INFO, "Начало записи файла");
        ...
        for (Statistics statistics : statisticsList) {
            ...
            profileCell.setCellValue(statistics.getMainProfile().toString());
            ...
            numberOfStudentsCell.setCellValue(statistics.getCountStudents());
            Cell numberOfUniversitiesCell = dataRow.createCell(3);
            numberOfUniversitiesCell.setCellValue(statistics.getCountUniversity());
            Cell universitiesCell = dataRow.createCell(4);
            universitiesCell.setCellValue(statistics.getNameUniversity());
        }
        ...
        try (FileOutputStream outputStream = new FileOutputStream(filePath)) {
            ...
            logger.log(Level.SEVERE, "Запись файла не удалась", e);
            return;
        }
